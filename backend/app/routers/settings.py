...
def _self_response(user: User, managed: list[uuid.UUID]) -> UserSelfResponse:
    return UserSelfResponse(
        ...
        email_notify_mentions=user.email_notify_mentions,
        email_notify_doc_approvals=user.email_notify_doc_approvals,
        email_notify_ocr_complete=user.email_notify_ocr_complete,
